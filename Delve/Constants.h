...
#define CREATURE_BADGUY_DAMAGE_DONE_MULT 80
...
#define GENERATOR_REJECT_BAD_TREASURE 90
#define GENERATOR_IMPLEMENT_CHANCE 65
#define GENERATOR_PATHEXPLORE_MAX 10000
