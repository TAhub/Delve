...
void makeInfoLabelInView(Creature *cr, UIView *view, int countdown)
{
	...
	statLabel2.text = [NSString stringWithFormat:@"%iD%@ %iM   %@", cr.damageBonus, cr.attackBonus > 0 ? [NSString stringWithFormat:@"+%iA", cr.attackBonus] : @"", cr.metabolism, countdown == 0 ? @"" : [NSString stringWithFormat:@"ROUNDS UNTIL CLEANSING: %i", countdown]];
